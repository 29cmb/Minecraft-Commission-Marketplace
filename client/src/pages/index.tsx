...
interface HomePageProps {
  totalPostsInCategory: number;
  totalPostsInPaper: number;
  totalPostsInSpigot: number;
  loggedIn: boolean;
}

const HomePage = ({ totalPostsInCategory, totalPostsInPaper, totalPostsInSpigot, loggedIn }: HomePageProps) => {
    return (
        <>
            <Topbar loggedIn={loggedIn} />
            <div className="bg-[#25262B] w-screen h-[35em] flex items-center justify-center">
            ...
            <div className="w-screen">
                <div className="flex space-x-8 pt-[100px] justify-center">
